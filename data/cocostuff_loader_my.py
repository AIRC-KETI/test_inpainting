...
class CocoSceneGraphDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for object_data in self.image_id_to_objects[image_id]:
            ...
            # print(object_data)  # [segmentation area iscrowd imageid bbox]
        ...
        triples = triples[:objs.size(0)]
        triples = torch.LongTensor(triples)
        # print(boxes)
        # print(image.shape, objs.shape, boxes.shape, triples.shape)
        return image, objs, boxes, triples,   #, masks ## , b_map #, None # obj_masks #, obj_masks # , b_map # masks # , triples
