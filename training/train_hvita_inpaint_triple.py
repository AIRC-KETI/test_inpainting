...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.total_epoch):
        ...
        for idx, data in enumerate(tqdm(dataloader)):
            ...
            content = {'image_contents': masked_images, 'mask': mask, 'label': label, 'bbox': selected_bbox, 'triples': triples, 'z': z, 'batch_randomly_selected': randomly_selected.unsqueeze(0).expand(b, -1)}
