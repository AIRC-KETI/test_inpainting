...
class Generator(nn.Module):
    def __init__(self, ch=16, z_dim=128, num_classes=10, pred_classes=7, output_dim=3, emb_dim=128, num_t=31):
        ...
        self.res2 = ResBlock(1024, 1024, num_w=159, upsample=False, predict_mask=False)  # 8
        self.res3 = ResBlock(1024, 512, num_w=159, upsample=True, predict_mask=False)  # 16
        self.res4 = ResBlock(512, 256, num_w=159, upsample=True, predict_mask=False)  # 32
        self.res5 = ResBlock(256, 128, num_w=159, upsample=True, predict_mask=False)  # 64
        self.res6 = ResBlock(128, 64, num_w=159, upsample=True, predict_mask=False)  # 128
